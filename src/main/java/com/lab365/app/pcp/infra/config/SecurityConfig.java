                ...
                http.csrf(AbstractHttpConfigurer::disable)
                                .authorizeHttpRequests(
                                                auth -> auth
                                                                ...
                                                                .requestMatchers(HttpMethod.POST, "/cadastro")
                                                                .hasRole(RolesEnum.ADMINISTRATOR.toString())
                                                                ...
                                                                .requestMatchers(antMatcher(HttpMethod.GET,
                                                                                ...
                                                                                antMatcher(HttpMethod.GET,
                                                                                                "/alunos/{id:[\\d+]}/pontuacao"))
                                                                .hasAnyRole(RolesEnum.ADMINISTRATOR.toString(),
                                                                                RolesEnum.PEDAGOGIC.toString(),
                                                                                RolesEnum.STUDENT.toString())
                                                                ...
                                                                .hasAnyRole(RolesEnum.ADMINISTRATOR.toString(),
                                                                                RolesEnum.PEDAGOGIC.toString(),
                                                                                RolesEnum.RECRUITER.toString())

                                                                .requestMatchers(antMatcher("/notas/**"))
                                                                .hasAnyRole(RolesEnum.ADMINISTRATOR.toString(),
                                                                                RolesEnum.TEACHER.toString())
