...
@Slf4j
@Service
public class GradeServiceImpl extends GenericServiceImpl<Grade> implements IGradeService {
        ...
        return grades.stream()
                ...
                .collect(Collectors.toMap(
                        ...
                        entry -> {
                            ...
                            BigDecimal average = countSubjects > 0
                                    ? sumGrades.divide(BigDecimal.valueOf(countSubjects), 2, RoundingMode.HALF_UP)
                                    : BigDecimal.ZERO;
